...
void main(int argc, char* argv[]) {
    ...
    sphere->SetPhiResolution(11);       //Set the number of points in the latitude direction
    sphere->SetThetaResolution(11);     //Set the number of points in the longitude direction
